...
contract SimpleBank {
    ...
    function deposit() public payable returns (uint) {
      ...
      require(enrolled[msg.sender]==true, "only owner can make deposit");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
      ...
      require (withdrawAmount <= balances[msg.sender],"should not be able to withdraw more than has been deposited");
